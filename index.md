...
$\frac{dy}{dx}^*$ If a member of a household is moving from A to B at 100 MPH, we can deduce that some infrastructure from commons (steel, gas, etc) is sustaining this biological impossibility (*i.e.,* they're in a car -- a hybrid ontology)
